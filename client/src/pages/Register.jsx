...
const Register = () => {
  ...
  const registerTitle = "Join Us.";
  const registerTitleArray = registerTitle.split("");
        ...
        {loaded && (
          ...
          >
            ...
            >
              ...
              <div className="text-3xl font-extrabold mb-6 text-center">
                <div className="overflow-hidden py-2">
                  <div className="flex justify-center flex-wrap">
                    {registerTitleArray.map((letter, index) => (
                      <motion.span
                        key={index}
                        custom={index}
              ...
              >
                Create an account to start exploring magazines and more.
              </motion.p>
